...
import { testAuthReconnectionSuccess } from "./auth-reconnection/auth-reconnection-success";
...
describe("game server reconnection", () => {
  ...
  it("auth reconnection success", async () => {
    testAuthReconnectionSuccess(testFixture);
  });
