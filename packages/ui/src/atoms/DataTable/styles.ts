...
// everything else about a table's look lives in DataTable's own jsx.
...
export const DATA_TABLE_CELL_CLASSES = `${CELL_BOX_CLASSES} overflow-hidden text-ellipsis whitespace-nowrap`;
export const DATA_TABLE_STACKED_CELL_CLASSES = CELL_BOX_CLASSES;
