...
export function clearFloorTexture(this: GameWorldView) {
...
export function drawCompass(gameWorld: GameWorldView) {
...
export function drawDebugGrid(gameWorld: GameWorldView) {
  const context = gameWorld.groundTexture.getContext();
  context.lineWidth = 3;
