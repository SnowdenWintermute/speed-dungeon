...
// import { ActionEntitySceneEntity } from "../action-entities";
...
//   const { combatantSceneEntityManager, actionEntityManager } = gameWorldView.sceneEntityService;
...
//     actionEntityManager.register(indicatorArrow);
...
//     indicatorArrow.handleLockRotationToFace({
//       identifier: {
...
// function spawnTargetChangedIndicatorArrow(position: Vector3, idGenerator: IdGenerator) {
...
//   const actionEntityModel = new ActionEntitySceneEntity(
//     entityId,
//     model,
//     position,
