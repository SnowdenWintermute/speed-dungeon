...
import { CustomMaterial } from "@/game-world-view/materials/material-colors";
...
function createDestinationMarkerSphere(modularCharacter: CharacterModel) {
  ...
  sphere.material = gameWorldView.current!.defaultMaterials.custom[CustomMaterial.AncientMetal];
