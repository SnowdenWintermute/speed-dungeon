...
import { getChildMeshByName, paintCubesOnNodes } from "@/game-world-view/game-world-view-utils";
...
export class EquipmentModel extends SceneEntity {
  ...
  setShowBones() {
    ...
    if (skeletonRootBone !== undefined)
      paintCubesOnNodes(skeletonRootBone, cubeSize, red, gameWorldView.current.scene);
  }
}
