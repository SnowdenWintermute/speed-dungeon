...
//   ) {
//     this.animationManager = new SkeletalAnimationManager(this.entityId, this.skeleton);
...
//     const skeleton = this.skeleton.meshes[0];
//     if (!skeleton) throw new Error("no skeleton found");

//     if (holstered)
//       attachHoldableModelToHolsteredPosition(skeleton, equipmentModelResult, slot, equipment);
//     else
//       attachHoldableModelToSkeleton(
//         skeleton,
