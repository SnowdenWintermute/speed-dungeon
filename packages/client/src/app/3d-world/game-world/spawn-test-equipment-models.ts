...
// import { equipmentBaseItemToModelPath } from "../item-models/equipment-base-item-to-model-path";
...
//     await spawnBaseItemModels(world, baseItemEnum);
//     i = 0;
//     j += 1;
//   }
...
// async function spawnBaseItemModels(world: GameWorld, baseItemEnum: EquipmentBaseItemEnum) {
...
//     const modelPath = equipmentBaseItemToModelPath(item);
//     if (modelPath === null) {
...
//       return (
//         a.equipmentBaseItemProperties.taggedBaseEquipment.equipmentType -
//         b.equipmentBaseItemProperties.taggedBaseEquipment.equipmentType
//       );
//     }
//     return 0;
//   });
