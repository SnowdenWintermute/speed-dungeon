...
export default function CombatantPlaque({ entityId, showExperience }: Props) {
  ...
  return (
    <div>
      <div
        className={`w-96 h-fit border bg-slate-700 pointer-events-auto flex p-2.5 relative box-border ${focused_class} `}
      ...
      >
        ...
        <div className="flex-grow" ref={name_and_bars_ref}>
