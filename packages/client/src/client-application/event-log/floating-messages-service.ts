...
export class FloatingMessageService {
  constructor(private store: FloatingMessagesStore) {}

  private dispatch(entityId: EntityId, elements: FloatingMessageElement[]) {
    this.store.startFloatingMessage(entityId, elements, FLOATING_MESSAGE_DURATION);
  }
  ...
  startBrokenHoldablesMessage(entityId: EntityId, equipment: Equipment) {
  ...
  startHitOutcomeMissMessage(entityId: EntityId) {
    const elements: FloatingMessageElement[] = [
      {
        type: FloatingMessageElementType.Text,
        text: `Miss`,
  ...
  startHitOutcomeEvadeMessage(entityId: EntityId) {
    const elements: FloatingMessageElement[] = [
      {
        type: FloatingMessageElementType.Text,
        text: `Evade`,
  ...
  startHitOutcomeParryMessage(entityId: EntityId) {
    const elements: FloatingMessageElement[] = [
      {
        type: FloatingMessageElementType.Text,
        text: `Parry`,
  ...
  startHitOutcomeCounteredMessage(entityId: EntityId) {
    const elements: FloatingMessageElement[] = [
      {
        type: FloatingMessageElementType.Text,
        text: `Countered`,
  ...
  startHitOutcomeResistedMessage(entityId: EntityId) {
    const elements: FloatingMessageElement[] = [
      {
        type: FloatingMessageElementType.Text,
        text: `Resisted`,
