...
export const COMBATANT_TIME_TO_MOVE_ONE_METER = 200;
export const COMBATANT_TIME_TO_ROTATE_360 = 10000;
export const MISSING_ANIMATION_DEFAULT_ACTION_FALLBACK_TIME = 2000;
