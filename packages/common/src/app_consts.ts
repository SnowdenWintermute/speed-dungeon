...
export const COMBATANT_TIME_TO_MOVE_ONE_METER = 1000;
export const COMBATANT_TIME_TO_ROTATE_360 = 1000;
export const MISSING_ANIMATION_DEFAULT_ACTION_FALLBACK_TIME = 1000;
export const DEFAULT_HITBOX_RADIUS_FALLBACK = 1;
export const DEFAULT_COMBAT_ACTION_PERFORMANCE_TIME = 3000;
