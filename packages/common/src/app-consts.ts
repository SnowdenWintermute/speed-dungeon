...
// CRAFTING
export const ITEM_REPAIR_COST_MULTIPLIER = 0.5;
export const ITEM_LEVEL_SHARD_REWARD_MULTIPLIER = 1.2;
export const SUFFIX_SHARD_REWARD_MULTIPLIER = 1.25;
export const AFFIX_TIER_SHARD_REWARD_MULTIPLIER = 2;
export const PREFIX_SHARD_REWARD_MULTIPLIER = 1.6;
export const DOUBLE_AFFIX_SHARD_REWARD_MULTIPLIER = 2.25;
