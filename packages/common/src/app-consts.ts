...
export const MONSTER_LAIRS_PER_FLOOR = 0;
export const EMPTY_ROOMS_PER_FLOOR = 0;
export const DEFAULT_LEVEL_TO_REACH_FOR_ESCAPE = 2;
export const GAME_CONFIG = { LEVEL_TO_REACH_FOR_ESCAPE: DEFAULT_LEVEL_TO_REACH_FOR_ESCAPE };
...
export const RACE_GAME_RECORDS_PAGE_SIZE = 5;
