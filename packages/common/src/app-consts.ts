...
export const ABILITY_POINTS_AWARDED_PER_LEVEL = 1;
export const ATTRIBUTE_POINTS_AWARDED_PER_LEVEL = 5;
export const ATTRIBUTE_POINTS_AWARDED_PER_SUPPORT_CLASS_LEVEL = 2;

export const COMBAT_ACTION_MAX_LEVEL = 3;
export const MAXIMUM_PET_SLOTS = COMBAT_ACTION_MAX_LEVEL;
...
export const CLIENT_LOG_RECORDER_MAX_BYTES = 5 * BYTES_PER_KB * BYTES_PER_KB;
