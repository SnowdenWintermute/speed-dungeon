...
export class ProvokeParticlesLarge extends CosmeticEffect {
  ...
  createParticleSystems(scene: Scene): ManagedParticleSystem[] {
    ...
    particleSystems.forEach((particleSystem, i) => {
      particleSystem.particleTexture = new Texture(`img/particle-textures/angry-face.png`, scene);
      particleSystem.minSize = 0.3;
      particleSystem.maxSize = 0.4;

      const mesh = new Mesh("", this.scene);

      particleSystem.addColorGradient(0, new Color4(0.6, 0.2, 0.2, 0));
      particleSystem.addColorGradient(0.5, new Color4(0.8, 0.2, 0.2, 0.9));
      particleSystem.addColorGradient(1, new Color4(0.3, 0.1, 0.1, 0.0));
