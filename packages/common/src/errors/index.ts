...
export const ERROR_MESSAGES = {
  ...
  SERVERS: {
    ...
    NO_LIVE_GAME_SERVERS:
      "No live game server is registered, so a game cannot be handed off. Check that at least one game server is running and reaching the registry.",
    MALFORMED_SECRET:
