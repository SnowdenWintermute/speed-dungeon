...
const stepType = ActionResolutionStepType.onActivationSpawnEntity;
export class OnActivationSpawnEntityActionResolutionStep extends ActionResolutionStep {
  constructor(context: ActionResolutionStepContext, idGenerator: IdGenerator) {
    ...
    // @TODO - determine based on action getOnActivationEntityToSpawn method
    const entity: Vfx = {
