...
import { CONDITION_TICK_ACTION_STEPS_CONFIG } from "./condition-tick.js";
...
export const ACTION_STEPS_CONFIG_TEMPLATE_GETTERS = {
  ...
  EXPLOSION_PARENT: () => cloneDeep(EXPLOSION_PARENT_STEPS_CONFIG),
  ...
  CONDITION_TICK: () => cloneDeep(CONDITION_TICK_ACTION_STEPS_CONFIG),
