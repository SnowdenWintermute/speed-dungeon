...
import { PROJECTILE_HIT_OUTCOME_PROPERTIES } from "./projectile.js";
import { THREATLESS_ACTION_HIT_OUTCOME_PROPERTIES } from "./threatless-action.js";
...
export const HIT_OUTCOME_PROPERTIES_TEMPLATE_GETTERS = {
  ...
  PROJECTILE: () => cloneDeep(PROJECTILE_HIT_OUTCOME_PROPERTIES),
  ...
  THREATLESS_ACTION: () => cloneDeep(THREATLESS_ACTION_HIT_OUTCOME_PROPERTIES),
};
