...
overrides.flatThreatGeneratedOnHit = { [ThreatType.Stable]: 1, [ThreatType.Volatile]: 1800 };
...
export const PROVOKE_HIT_OUTCOME_PROPERTIES = createHitOutcomeProperties(base, overrides);
