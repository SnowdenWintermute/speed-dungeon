...
export const DEATH_ACTION_RESOURCE_PROPERTY_CHANGE_GETTERS: ResourceChangePropertiesGetters = {
...
export const passTurnConfig: CombatActionComponentConfig = {
  ...
  hitOutcomeProperties: createHitOutcomeProperties(
    ...
    {
      resourceChangePropertiesGetters: DEATH_ACTION_RESOURCE_PROPERTY_CHANGE_GETTERS,
    }
  ),
