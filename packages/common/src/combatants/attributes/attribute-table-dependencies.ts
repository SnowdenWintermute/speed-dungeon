// everything attribute-tables.generated.ts refers to, so the emitter writes one import line instead
// of carrying a copy of these paths. move any of these files and the compiler points here
